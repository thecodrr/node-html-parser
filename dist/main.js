...
define("nodes/html", ["require", "exports", "entities", "css-select", "nodes/node", "nodes/type", "nodes/text", "matcher", "back", "nodes/comment"], function (require, exports, entities_2, css_select_1, node_2, type_3, text_1, matcher_1, back_1, comment_1) {
    ...
    var HTMLElement = /** @class */ (function (_super) {
        ...
        HTMLElement.prototype.hasChildNodes = function () {
     ...
     * @extends {HTMLElement}
     */
    var HTMLRootElement = /** @class */ (function (_super) {
        __extends(HTMLRootElement, _super);
        function HTMLRootElement() {
            return _super !== null && _super.apply(this, arguments) || this;
        }
        HTMLRootElement.prototype.createElement = function (tagName, _options) {
            return new HTMLElement(tagName, {}, '', null);
        };
        return HTMLRootElement;
    }(HTMLElement));
    exports.HTMLRootElement = HTMLRootElement;
    ...
    function base_parse(data, options) {
        ...
        var root = new HTMLRootElement(null, {}, '', null, [0, data.length]);
